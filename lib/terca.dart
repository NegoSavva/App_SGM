            ...
            child: Padding(
              ...
              child: ListView(
                children: const [
                 _Section(
  title: "Café da Manhã",
  items: ["Leite com achocolatado", "Pão com requeijão", "Fruta da estação"],
),

_Section(
  title: "Almoço",
  items: ["Arroz", "Feijão", "Frango grelhado", "Salada de tomate e alface"],
),
_Section(
  title: "Lanche da Tarde",
  items: ["Iogurte", "Fruta picada", "Bolacha de água e sal"],
),
